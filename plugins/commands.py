...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('🙆🏻 Help 🦾', url=f"https://t.me/imoviesmagic_bot?start=help"),
            ],[
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('➕↖️ Add Me To Your Groups ↗️➕', url=f'http://t.me/imoviesmagic_bot?startgroup=true')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if message.command[1] != "subscribe":
            try:
                ...
                btn.append([InlineKeyboardButton(" 🔄 Try Again", url=f"https://t.me/imoviesmagic_bot?start={message.command[1]}")])
...
async def delete_all_index_confirm(bot, message):
    ...
    await message.answer('♥️ Thank You imoviesmagic ♥️')
